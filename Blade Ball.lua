game.StarterGui:SetCore("SendNotification", {
    ...
    local Window = Library.CreateLib("Avantum - Fix", "DarkTheme")
    
    local Tab = Window:NewTab("Combat")
    local Tab2 = Window:NewTab("Shop")
    local Tab3 = Window:NewTab("World/Mics")
    ...
    local Credits = Tab4:NewSection("Coding by @elsrt_alex")
    local Credits1 = Tab4:NewSection("Modified Parry Legit for @elsrt_alex")
    ...
    Combat:NewToggle("Auto Parry - Legit", "Coding @elsrt_alex", function(toggled)
        resolve_parry_Remote()
        getgenv().aura_Enabled = toggled
    end)
    
    Combat:NewButton("Auto Spam (One Click)", "ButtonInfo", function()
    getgenv().Paws = {
        ["AutoParry"] = true,
        ["PingBased"] = true,
        ["PingBasedOffset"] = 0,
    ...
    World:NewToggle("RTX Shaders", "ToggleInfo", function(toggled)
